...
\begin{itemize}
  ...
  \item Kissat verliert Zeit in aufeinanderfolgenden
        UNSAT-Nachweisen
...
\begin{frame}{Fazit \& Ausblick}
  \begin{block}{Zusammenfassung}
    \begin{itemize}
        ...
        \item MaxHS vermeidet die iterative Suche über k
        \item Zusätzliche Kandidatenrunden erhöhen die Instanzgröße stark
        \item Kandidatengenerierung dominiert bei großen Instanzen
    \end{itemize}
  \end{block}
